...
- BTC/ETH current price from Delta public ticker/WebSocket
- BTC/ETH historical candles from `/v2/history/candles`
- BTC/ETH CE/PE options, expiry, premium, bid/ask, OI and Greeks when Delta supplies them
